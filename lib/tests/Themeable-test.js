...
describe('themeable()', function () {
  ...
  it('passes context and props to constructor', function () {
    var themedElem = shallowRender(_react2.default.createElement(ThemeableComponent, null), { ctx: 'ctx' });

    (0, _expect2.default)(themedElem.props.ctx).toBe('ctx');
  });
